...
void  DocumentView::copyClipboardSlot(QPoint pos,bool copy,bool zoom)
{
    //  qDebug()<<"clipBoard gerçekleşti";
      emit mainClipBoard(pos,copy,zoom);
    ...
    m_searchTask(0)
{
   ...
   // connect(scene, SIGNAL(sceneItemAddedSignal(int)),
     //  this,SLOT(viewItemAddedSignalSlot(int)));
...
//    setScene(new QGraphicsScene(this));
 ...
 ///   setMouseTracking(true);
  ...
  //  setDragMode(QGraphicsView::ScrollHandDrag);
    ...
    m_thumbnailsScene = new Scene(this);
...
void DocumentView::viewItemAddedSignalSlot(int a)
{
    qDebug()<<"view burası added";

   // emit mainSceneItemAddedSignal(a);
}
void DocumentView::preparePages()
{
    ...
    for(int index = 0; index < m_pages.count(); ++index)
    {
       ...
       // scene()->addItem(page);
        ...
        connect(page, SIGNAL(copyClipboardSignal(QPoint,bool,bool)), SLOT(copyClipboardSlot(QPoint,bool,bool)));
