...
signals:
    void mainClipBoard(QPoint pos,bool copy,bool zoom);//copyMode
    void mainSceneItemAddedSignal(int a);
...
public slots:
     void copyClipboardSlot(QPoint pos, bool copy, bool zoom);//copyMode
     void viewItemAddedSignalSlot(int a);
    void show();
